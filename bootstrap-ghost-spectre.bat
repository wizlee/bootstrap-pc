...
goto setup_pc_using_boxstarter

:setup_pc_using_boxstarter
...
powershell -ExecutionPolicy Bypass -Command "Start-Process Powershell -Verb RunAs -Wait -ArgumentList '-NoProfile -ExecutionPolicy Bypass -File "%~dp0\bootstrap-ghost-spectre.ps1"'"
if %errorLevel% == 0 (
